...
| D5 | Finanças via **Pluggy** (open finance), não entrada manual | entrada manual não é confiável | dono, 2026-09-20 | entrada manual de transações | custo real do Pluggy medido e inviável (medido em 2026-09-26: gratuito para uso pessoal pelo Meu Pluggy, até 5 conexões; o gatilho segue valendo se isso mudar) | `docs/fontes/pluggy-open-finance.md` |
